...
<head>
    ...
    window.trackRecentlyViewed = function(type, id, name, url) {
        var KEY = 'keystone_recently_viewed';
        var items = [];
...
<body class="layout-fluid" data-bs-theme="{{ auth()->check() && auth()->user()->theme === 'dark' ? 'dark' : 'light' }}">
    ...
    <div class="page">
        @include('layouts._mobile_app_shell')
        <!-- Sidebar -->
            ...
            <div class="container-fluid">
                ...
                <h1 class="navbar-brand navbar-brand-autodark" style="margin-bottom: 0;">
                    <a href="{{ route('dashboard') }}" style="display:inline-block; background:#fff; border-radius:8px; padding:6px 10px; box-shadow:0 1px 3px rgba(0,0,0,.4);">
                        <img src="{{ asset('images/logo-white.png') . '?v=keystone' }}" alt="{{ config('app.name') }}" style="display:block; max-height: 60px; max-width: 260px;">
                    </a>
                </h1>
                <div class="collapse navbar-collapse" id="sidebar-menu">
                    <ul class="navbar-nav pt-lg-1" role="list">
                        ...
                        <li class="nav-item ms-3">
                            <a class="nav-link" href="{{ route('availability-sources.index') }}">
                                <span class="nav-link-icon">
                                ...
                                <span class="nav-link-title">{{ __('Availability Lists') }}</span>
                            </a>
                        </li>
                        @endif
                        ...
                        <li class="nav-item {{ request()->is('showings*') ? 'active' : '' }}">
                            <a class="nav-link" href="{{ route('showings.index') }}">
                                ...
                                <span class="nav-link-title">{{ __('Viewings') }}</span>
                            </a>
                        </li>
