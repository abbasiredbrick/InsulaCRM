...
@section('title', __('Sales Mandates'))
@section('page-title', __('Sales Mandates'))
...
<div class="card">
    <div class="card-header">
        ...
        <div class="card-actions">
            <a href="{{ route('listings.index') }}" class="btn btn-sm btn-outline-secondary">{{ __('Listed Units') }}</a>
        </div>
    </div>

    {{-- Filters --}}
    <div class="card-body border-bottom py-3">
        <form method="GET" action="{{ route('listings.mandates') }}" class="row g-2 align-items-end">
            <div class="col-md-2">
            ...
            <div class="col-auto">
                ...
                <a href="{{ route('listings.mandates') }}" class="btn btn-sm btn-outline-secondary">{{ __('Reset') }}</a>
            </div>
        </form>
    </div>
