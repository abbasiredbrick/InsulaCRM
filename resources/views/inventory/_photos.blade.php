<div class="card mb-3" id="photos-section">
    <div class="card-header">
        ...
        <div class="card-actions">
            <span class="text-secondary">{{ $property->media->where('type', 'photo')->count() }} {{ __('photo(s)') }}</span>
    ...
    <div class="card-body collapse show" id="section-photos">
            ...
            <div class="col-6 col-sm-4 col-md-3">
                ...
                <div class="mt-1">
                    <small class="text-secondary" title="{{ $photo->original_name }}">
                        {{ $photo->uploader->name ?? __('Unknown') }} &middot; {{ \App\Helpers\TenantFormatHelper::date($photo->created_at) }}
                    </small>
                </div>
            </div>
            @endforeach
        ...
        <!-- Upload Form -->
        <form action="{{ route('inventory.photos.upload', $property) }}" method="POST" enctype="multipart/form-data" id="photo-upload-form">
            @csrf
            <div class="mb-2">
