...
class SearchController extends Controller
{
    public function search(Request $request)
    {
        ...
        // Leads (supports scope=leads or all) — shared app-wide search rules
        // (see LeadSearchService): same term columns and visibility scoping.
        if (in_array($scope, ['leads', 'all']) && $user->canManageLeads()) {
            $leads = app(\App\Services\LeadSearchService::class)
