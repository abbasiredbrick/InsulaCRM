...
class AvailabilitySourceController extends Controller
{
    ...
    public function store(Request $request)
    {
        $data = $request->validate([
            ...
            'default_deposit_pct' => 'nullable|numeric|between:0,100',
            'default_deposit_min' => 'nullable|numeric|min:0',
    ...
    public function update(Request $request, AvailabilitySource $source)
    {
        ...
        $source->update([
            ...
            'default_deposit_pct' => $data['default_deposit_pct'] ?? null,
            'default_deposit_min' => $data['default_deposit_min'] ?? null,
